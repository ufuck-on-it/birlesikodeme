...
var BirlesikOdeme = /** @class */ (function () {
    function BirlesikOdeme(baseUrl, password, lang, email, hashPassword) {
        ...
        this.authenticate(password, lang, email).catch(function (error) { return console.log('Authentication failed:', error); });
    }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        this.httpClient.defaults.headers.common['Authorization'] = "Bearer ".concat(result.token);
                        return [3 /*break*/, 3];
                    case 2:
                        error_1 = _b.sent();
