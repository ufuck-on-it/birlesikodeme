...
exports.UnitedPayment = void 0;
var axios_1 = require("axios");
var crypto_1 = require("crypto");
var UnitedPayment = /** @class */ (function () {
    function UnitedPayment(baseUrl, token, hashPassword) {
    ...
    UnitedPayment.prototype.calculateHash = function (data) {
        var hash = (0, crypto_1.createHash)('sha512');
        hash.update(data, 'utf16le');
        return hash.digest('hex');
    };
    UnitedPayment.prototype.authorizePaymentIFrame = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            var calculatedHash, response, data, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        calculatedHash = this
                            .calculateHash("".concat(this.hashPassword, "+").concat(request.userCode, "+").concat(request.rnd, "+").concat(request.txnType, "+").concat(request.totalAmount, "+\n            ").concat(request.customerId, "+").concat(request.orderId, "+").concat(request.okUrl, "+").concat(request.failUrl));
                    ...
                    case 2:
                        error_1 = _a.sent();
                        console.error('Payment authorization failed:', error_1);
                        throw error_1;
    ...
    UnitedPayment.prototype.noneSecurePayment = function (request) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    UnitedPayment.prototype.Payment3d = function (request) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    UnitedPayment.prototype.paymentInquiry = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_4 = _a.sent();
                        console.error('Payment inquiry failed:', error_4);
                        throw error_4;
                    case 3: return [2 /*return*/];
                }
            });
    ...
    UnitedPayment.prototype.getCommissionSale = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_5 = _a.sent();
                        console.error('Failed to fetch commission sale:', error_5);
                        throw error_5;
                    case 3: return [2 /*return*/];
                }
            });
    ...
    UnitedPayment.prototype.getCommissionInstall = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_6 = _a.sent();
                        console.error('Failed to fetch commission install:', error_6);
                        throw error_6;
                    case 3: return [2 /*return*/];
                }
            });
    ...
    UnitedPayment.prototype.getBinListWithId = function (bin) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_7 = _a.sent();
                        console.error('Failed to fetch BIN list:', error_7);
                        throw error_7;
                    case 3: return [2 /*return*/];
                }
            });
    ...
    UnitedPayment.prototype.saveCardWithoutTransaction = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_8 = _a.sent();
                        console.error('Failed to save card without transaction:', error_8);
                        throw error_8;
                    case 3: return [2 /*return*/];
                }
            });
    ...
    UnitedPayment.prototype.getTransactionList = function (merchantId, orderNo, txnTypeList, cardMask, startDate, endDate, responseCode, txnStatus, authCode, customerId, page, pageSize, sortOrder, sortField) {
        return __awaiter(this, void 0, void 0, function () {
            var request, response, data, error_9;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 2:
                        error_9 = _a.sent();
                        console.error('Failed to get transaction list:', error_9);
                        throw error_9;
                    case 3: return [2 /*return*/];
                }
            });
    ...
    UnitedPayment.prototype.getMerchantList = function (parentMerchantId, identityNumber, taxNumber, page, pageSize, sortOrder, sortField) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_10 = _a.sent();
                        console.error('Failed to get merchant list:', error_10);
                        throw error_10;
                    case 3: return [2 /*return*/];
                }
            });
    ...
    UnitedPayment.prototype.getBinList = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_11 = _a.sent();
                        console.error('Failed to get BIN list:', error_11);
                        throw error_11;
                    case 3: return [2 /*return*/];
                }
            });
    ...
    UnitedPayment.prototype.cardCheckPoints = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_12 = _a.sent();
                        console.error('Failed to check card points:', error_12);
                        throw error_12;
                    case 3: return [2 /*return*/];
                }
            });
    ...
    UnitedPayment.prototype.cancelOrRefund = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_13 = _a.sent();
                        console.error('Failed to cancel or refund:', error_13);
                        throw error_13;
                    case 3: return [2 /*return*/];
                }
            });
    ...
    UnitedPayment.prototype.ManuelPayment = function (paymentRequest) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_14 = _a.sent();
                        console.error('Failed to check card points:', error_14);
                        throw error_14;
                    case 3: return [2 /*return*/];
                }
            });
    ...
    UnitedPayment.prototype.commissionInquiry = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_15 = _a.sent();
                        console.error('Commission inquiry failed:', error_15);
                        throw error_15;
                    case 3: return [2 /*return*/];
                }
            });
    ...
    UnitedPayment.prototype.installmentInquiry = function (merchantId, bin, txnType) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_16 = _a.sent();
                        console.error('Installment inquiry failed:', error_16);
                        throw error_16;
                    case 3: return [2 /*return*/];
                }
            });
    ...
    UnitedPayment.prototype.getCardList = function (memberId, merchantId, customerId, userCode, rnd, hash) {
        return __awaiter(this, void 0, void 0, function () {
            var calcHash, request, response, data, error_17;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 2:
                        error_17 = _a.sent();
                        console.error('Failed to get card list:', error_17);
                        throw error_17;
                    case 3: return [2 /*return*/];
                }
            });
    ...
    UnitedPayment.prototype.getCustomerCards = function (memberId, merchantId, customerId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_18 = _a.sent();
                        console.error('Failed to get customer cards:', error_18);
                        throw error_18;
                    case 3: return [2 /*return*/];
                }
            });
    ...
    UnitedPayment.prototype.deleteCustomerCard = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_19 = _a.sent();
                        console.error('Failed to delete customer card:', error_19);
                        throw error_19;
                    case 3: return [2 /*return*/];
                }
            });
    ...
    UnitedPayment.prototype.orderInquiry = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_20 = _a.sent();
                        console.error('Failed to inquire order:', error_20);
                        throw error_20;
                    case 3: return [2 /*return*/];
                }
            });
    ...
    return UnitedPayment;
}());
exports.UnitedPayment = UnitedPayment;
